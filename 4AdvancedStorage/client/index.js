...
const initApp = async () => {
  ...
  var address = await kleros.options.address;
  console.log(address)

  var maxDrawingTime = await kleros.methods.maxDrawingTime().call();
  console.log(maxDrawingTime)
